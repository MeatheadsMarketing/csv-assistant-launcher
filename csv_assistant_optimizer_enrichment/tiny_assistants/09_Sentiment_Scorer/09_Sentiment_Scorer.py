...
def sentiment_scorer(df: pd.DataFrame, **kwargs) -> pd.DataFrame:
    """
    ...
    try:
        st.info("Running assistant: Sentiment Scorer")
        # TODO: Implement enrichment logic here
        pass
    except Exception as e:
        st.error(f"Error in assistant 'Sentiment Scorer': {e}")

    return df_enriched

def run_ui():
    st.title("Sentiment Scorer")
    st.write("Adds sentiment tags (positive, neutral, negative) to text fields.")
